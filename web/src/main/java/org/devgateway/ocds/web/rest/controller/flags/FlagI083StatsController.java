...
@Cacheable
public class FlagI083StatsController extends AbstractFlagStatsController {
    ...
    @Override
    @ApiOperation(value = "Stats for flag i083")
    @RequestMapping(value = "/api/flags/i083/stats",
