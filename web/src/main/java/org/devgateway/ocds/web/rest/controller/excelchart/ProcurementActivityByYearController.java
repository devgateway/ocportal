...
public class ProcurementActivityByYearController extends ExcelChartOCDSController {
    ...
    @Operation(summary = "Exports *Procurement activity by year* dashboard in Excel format.")
    ...
    public void procurementActivityExcelChart(@ModelAttribute @Valid final LangYearFilterPagingRequest filter,
        ...
        final List<Document> countAwardsByYear = countPlansTendersAwardsController.countAwardsByYear(filter);
        final List<Document> countTendersByYear = countPlansTendersAwardsController.countTendersByYear(filter);
