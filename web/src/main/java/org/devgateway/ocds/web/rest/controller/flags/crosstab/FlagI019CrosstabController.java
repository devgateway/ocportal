...
@Cacheable
public class FlagI019CrosstabController extends AbstractSingleFlagCrosstabController {

    @Override
    @Operation(summary = "Crosstab for flag i019")
    ...
    public List<Document> flagStats(@ModelAttribute @Valid YearFilterPagingRequest filter) {
        return super.flagStats(FlagsConstants.I019_VALUE, filter);
    }
}
