...
@Cacheable
public class FlagI171CrosstabController extends AbstractSingleFlagCrosstabController {

    @Override
    @Operation(summary = "Crosstab for flag i171")
    ...
    public List<Document> flagStats(@ModelAttribute @Valid YearFilterPagingRequest filter) {
        return super.flagStats(FlagsConstants.I171_VALUE, filter);
    }
}
