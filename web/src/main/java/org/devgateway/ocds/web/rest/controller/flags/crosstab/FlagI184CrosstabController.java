...
@Cacheable
public class FlagI184CrosstabController extends AbstractSingleFlagCrosstabController {

    @Override
    @ApiOperation(value = "Crosstab for flag i184")
    @RequestMapping(value = "/api/flags/i184/crosstab",
