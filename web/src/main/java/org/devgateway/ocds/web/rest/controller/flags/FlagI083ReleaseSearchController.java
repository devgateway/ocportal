...
@Cacheable
public class FlagI083ReleaseSearchController extends AbstractFlagReleaseSearchController {
    @Override
    protected String getFlagProperty() {
        return FlagsConstants.I083_VALUE;
    }

    @Override
    @ApiOperation(value = "Search releases by flag i083")
    ...
    @Override
    @ApiOperation(value = "Counts releases by flag i083")
