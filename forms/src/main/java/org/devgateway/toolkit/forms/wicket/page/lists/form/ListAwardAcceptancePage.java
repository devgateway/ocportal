...
import org.devgateway.toolkit.forms.wicket.components.table.filter.form.AwardAcceptanceFilterState;
...
public class ListAwardAcceptancePage extends ListAbstractMakueniEntityPage<AwardAcceptance> {
    @SpringBean
