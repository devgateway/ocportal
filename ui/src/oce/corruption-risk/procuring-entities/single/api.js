...
const getProcurementsByStatusData = (filters) => fetch('/procurementsByTenderStatus', filters)
  .then(procurementMapper);

const getProcurementsByMethodData = (filters) => fetch('/procurementsByProcurementMethod', filters)
  .then(procurementMapper);
