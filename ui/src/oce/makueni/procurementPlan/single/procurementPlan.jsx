              ...
              ? (
                <div>
                  ...
                  data.planItems.map((planItem) => (
                    <div key={planItem.id} className="box">
                    ...
                    <div className="row">
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:unitOfIssue')}
                        value={planItem.unitOfIssue.label}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:quantity')}
                        value={currencyFormatter(planItem.quantity)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:estimatedCost')}
                        value={currencyFormatter(planItem.estimatedCost)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:totalCost')}
                        value={currencyFormatter(planItem.quantity * planItem.estimatedCost)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:procurementMethod')}
                        value={planItem.procurementMethod.label}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:sourceOfFunds')}
                        value={planItem.sourceOfFunds}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:targetGroupValue')}
                        value={currencyFormatter(planItem.targetGroupValue)}
                        col={3}
                      />
                      )}
                      </div>
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:quarter1st')}
                        value={currencyFormatter(planItem.quarter1st)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:quarter2nd')}
                        value={currencyFormatter(planItem.quarter2nd)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:quarter3rd')}
                        value={currencyFormatter(planItem.quarter3rd)}
                        col={3}
                      />
                      )}
                      ...
                      && (
                      <Item
                        label={t('procurementPlan:item:quarter4th')}
                        value={currencyFormatter(planItem.quarter4th)}
                        col={3}
                      />
                      )}
                      </div>
