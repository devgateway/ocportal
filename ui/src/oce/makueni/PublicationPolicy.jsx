      ...
      <div className="container-fluid dashboard-default">
        ...
        <div className="makueni-procurement-plan content row">
          ...
          <div className="col-md-6 col-md-offset-3 text-justify">
            ...
            <div>
              <img src={`${process.env.PORTAL_URL}/ocmakueni-architecture.png`} />
            ...
            {reactStringReplace(t('publicationPolicy:ocdsMapping:text'), '$#$',
              (m, i) => {
                if (i === 1) {
                  return <a key={i} className="download-file" href={`${process.env.PORTAL_URL}/Makueni-OCDS-Conversion-Matrix.xlsx`}>{t('publicationPolicy:ocdsMapping:text:link1')}</a>;
                }
                return <a key={i} target="_blank" className="download-file" href={`${process.env.PORTAL_URL}/javadoc/dao/index.html`}>{t('publicationPolicy:ocdsMapping:text:link2')}</a>;
              })}
          </div>
