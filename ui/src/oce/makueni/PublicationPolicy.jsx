      ...
      <div className="container-fluid dashboard-default">
        ...
        <div className="makueni-procurement-plan content row">
          ...
          <div className="col-md-6 col-md-offset-3 text-justify">
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/contract_contractor"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/first_time_winners"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/fiscal_year"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/milestone_delayed_authorization"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/planning_items"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/target_groups"
            >
            ...
            <a
              className="download-file"
              href="https://github.com/devgateway/forms-makueni/tree/master-makueni/persistence-mongodb/src/main/resources/extensions/tender_location"
            >
