  ...
  const childElements = (i) => {
    ...
    return (<div>
      <div className="row display-flex">
        ...
        && <Item label={t("paymentVoucher:contractNumber")} value={currencyFormatter(i.contract.referenceNumber)}
                 col={3}/>}
      </div>
    </div>);
  }

  return (<ImplReport {...props} fmPrefix={"publicView.paymentVoucher"} reportName={t("paymentVoucher:label")}
