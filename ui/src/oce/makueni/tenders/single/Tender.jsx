  ...
  const getTenderView = (tender) => {
    return (<div>
      <div className="row display-flex">
        ...
        && <Item label={t("tender:procurementMethodRationale")}
        ...
        tender.tenderItems !== undefined && isFeatureVisible("publicView.tender.tenderItems")
            ? <div>
              <div className="row padding-top-10">
                <div className="col-md-12 sub-title">{t("tender:tenderItems")}
...

              {
                tender.tenderItems.map(tenderItem => <div key={tenderItem._id} className="box">
                  <div className="row display-flex">
                    ...
                    &&
                    <Item label={t("tender:item:unitOfIssue")} value={tenderItem.purchaseItem.planItem.unitOfIssue.label}
                          col={3}/>}
                    ...
                    && <Item label={t("tender:item:totalCost")}
      ...
      <div className="row">
        ...
        && <Item label={t("tender:item:dlTender")} col={6}
