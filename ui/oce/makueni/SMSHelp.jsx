    ...
    return (<div className="container-fluid dashboard-default">
      ...
      <div className="makueni-procurement-plan content">
        ...
        <div className="col-md-8 col-md-offset-2">
          ...
          Once the message is sent, you will receive an SMS like the one below:<p>
          <samp>
          Tender Code: 41802<br/>
          Tender Name: CONSTRUCTION OF 2 DOOR NO. PIT LATRINES AND URINAL AT KATIKOMU ECDE CENTER ILIMA WARD<br/>
          M&E Status: Complete and in use<br/>
          PMC Status: At risk<br/>
          </samp>
        </p>
        </div>
        </div>
        ...
        <div className="col-md-8 col-md-offset-2">
          ...
          <p>For example, <kbd>CON REPORT 41802 work has been stopped for months</kbd></p>
