    ...
    return (<div className="container-fluid dashboard-default">
      ...
      <div className="makueni-procurement-plan content row">
        ...
        <div className="col-md-6 col-md-offset-3 text-justify">
          ...
          <ul>
            <li><b>{this.t("publicationPolicy:dataScope:line1:label")}</b>{this.t("publicationPolicy:dataScope:line1:text")}</li>
            <li><b>{this.t("publicationPolicy:dataScope:line2:label")}</b>{this.t("publicationPolicy:dataScope:line2:text")}</li>
            <li><b>{this.t("publicationPolicy:dataScope:line3:label")}</b>{this.t("publicationPolicy:dataScope:line3:text")}</li>
            <li><b>{this.t("publicationPolicy:dataScope:line4:label")}</b>{this.t("publicationPolicy:dataScope:line4:text")}</li>
            <li><b>{this.t("publicationPolicy:dataScope:line5:label")}</b>{this.t("publicationPolicy:dataScope:line5:text")}</li>
            <li><b>{this.t("publicationPolicy:dataScope:line6:label")}</b>{this.t("publicationPolicy:dataScope:line6:text")}</li>
          </ul>
          ...
          {this.t("publicationPolicy:dataAndExceptions:text")}<p/>
          ...
          <a className="download-file"
            ...
            {this.t("publicationPolicy:dataAndExceptions:contractContractor")}</a>
          <p/>
          ...
          <a className="download-file"
            ...
            {this.t("publicationPolicy:dataAndExceptions:delayedMilestone")}</a>
          <p/>
          <a className="download-file"
            ...
            {this.t("publicationPolicy:dataAndExceptions:plannedItems")}</a>
          <p/>
          <a className="download-file"
            ...
            {this.t("publicationPolicy:dataAndExceptions:targetGroups")}</a>
          <p/>
          <a className="download-file"
            ...
            {this.t("publicationPolicy:dataAndExceptions:tenderLocation")}</a>
          <p/>
          <a className="download-file"
             href="https://github.com/open-contracting-extensions/ocds_bid_extension">
            {this.t("publicationPolicy:dataAndExceptions:bidExtension")}</a>
          <p/>
          <a className="download-file"
             href="https://github.com/open-contracting-extensions/ocds_budget_breakdown_extension">
            {this.t("publicationPolicy:dataAndExceptions:budgetBreakdownExtensions")}</a>
          <p/>
          <a className="download-file"
             href=" https://github.com/open-contracting-extensions/ocds_location_extension">
            {this.t("publicationPolicy:dataAndExceptions:locationExtension")}</a>

          <h3>{this.t("publicationPolicy:ocdsMapping:title")}</h3>
          {reactStringReplace(this.t("publicationPolicy:ocdsMapping:text"), "$#$",
              (m, i) => {
                if (i === 1) {
                  return <a key={i} className="download-file" href="assets/Makueni-OCDS-Conversion-Matrix.xlsx">{this.t("publicationPolicy:ocdsMapping:text:link1")}</a>
                } else {
                  return <a key={i} target="_blank" className="download-file" href="assets/javadoc/dao/index.html">{this.t("publicationPolicy:ocdsMapping:text:link2")}</a>
                }
              })}
        </div>
